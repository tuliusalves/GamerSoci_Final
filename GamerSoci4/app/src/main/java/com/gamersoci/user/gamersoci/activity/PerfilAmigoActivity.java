...
import com.gamersoci.user.gamersoci.adapter.AdapterGrid;
import com.gamersoci.user.gamersoci.helper.ConfiguracaoFirebase;
import com.gamersoci.user.gamersoci.model.Postagem;
...
public class PerfilAmigoActivity extends AppCompatActivity {
    ...
    private void habilitarBotaoSeguir( boolean segueUsuario ){
        ...
        /**função para salvar seguidor*/
    private void salvarSeguidor(Usuario uLogado, Usuario uAmigo){
        /*ESTRUTURA
        1-SEGUIDORES 2-USUÁRIO QUE ESTÁ LOGADO 3- USUÁRIO QUE QUER SEGUIR 4-DADOS SEGUINDO
         */
        //-1-Vamos fazer um HashMap apenas salvando o nome e o caminho da foto do usuário
    ...
    /**recupera dados onstart activity*/
    @Override
    ...
    protected void onStop() {
        ...
        /** recupera dados do perfil do amigo*/
